...
public class SearchTruckActivity extends AppCompatActivity implements CommonInterface, View.OnClickListener, FilterFragment.FilterFragmentInterface {
    Toolbar toolbar;
    ...
    String ftl, ltl, oneway, roundtrip, selectdate;
    ...
    public void initComponent() {
        try {
            ...
            mAdapter = new TruckListAdapter(this, this);
    ...
    public void getPostTruckList(String pickCity, String vehicle, String dest) {
        ...
        try {
            db.open();
            truckList = db.getTruckListByVehicle(vehicle, pickCity, dest);
            db.close();
            mAdapter.updateTruckList(truckList);
            if (truckList.size() == 0) {
                emptyView.setVisibility(View.VISIBLE);
                emptyView.setText("No truck Available");
            } else {
    ...
    public void ReceiveEnquiry(Object enquiry) {
        ...
        Intent intent = new Intent(this, ViewTruckActivity.class);
        intent.putExtra("current", pos);
        intent.putExtra("trucklist", mAdapter.trucklist);
...
/*
    ...
    public void cancelTruckSearch() {
        trucktext.setText("Search Truck");
        vehicle = null;
        getPostTruckList(fromcity, vehicle, tocity);
    }
