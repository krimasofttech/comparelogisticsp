...
import logistic.compare.comparelogistic.Quoted.QuotedActivity;
import logistic.compare.comparelogistic.R;

/**
 * Created by Sony on 2/26/2016.
 */
public class WonAdapter extends RecyclerView.Adapter<WonAdapter.ViewHolder> implements CommonUtility {

    static ArrayList<EnquiryColumns> enquirylist;
    public Context context;
    DB db;
    CommonInterface wonFragment;
    ...
    public static void setEnquirylist(ArrayList<EnquiryColumns> enquirylist) {
        WonAdapter.enquirylist = enquirylist;
    }

    View rootView;

    public WonAdapter(Context context, ArrayList<EnquiryColumns> enquirylist, CommonInterface wonFragment) {
        this.context = context;
        this.enquirylist = enquirylist;
        db = new DB(context);
        this.wonFragment = wonFragment;
    }
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        ...
        holder.rootView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                holder.loader.setTag(v.getTag());
                //holder.loader.setVisibility(View.VISIBLE);
                wonFragment.ReceiveEnquiry(holder.loader);
    ...
    private void setDataOnView(ViewHolder mViewHolder, EnquiryColumns ec) {
        try {
            ...
            mViewHolder.remark.setText(obj1.getString(REMARK));
            mViewHolder.validity.setText(obj1.getString(VALIDITY));
            mViewHolder.price.setText("₹" + obj1.getString(PRICE));
            mViewHolder.days.setText(obj1.getString(DAYS) + " days");
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View convertView) {
            ...
            statusicon.setImageResource(R.drawable.won);
