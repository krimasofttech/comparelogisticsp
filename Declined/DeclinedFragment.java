...
public class DeclinedFragment extends Fragment implements CommonUtility, CommonInterface {
    View rootView;
    ProgressBar loader;
    RecyclerView listView;
    public static DeclinedAdapter mAdapter;
    ArrayList<EnquiryColumns> enquiryList;
    DeclinedIntentService quotedintentservice;
    DB db;
    SwipeRefreshLayout swipeRefreshLayout;
    LinearLayoutManager layoutmanager;
    TextView emptyText;
    private OnDeclinedFragment mListener;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (rootView == null) {
            rootView = inflater.inflate(R.layout.fragment_declined, container, false);
        }
    ...
    public void setAdapter() {
        ...
        mAdapter = new DeclinedAdapter(getActivity(), enquiryList);
    ...
    private ServiceConnection mServiceConnection = new ServiceConnection() {
        ...
        public void onServiceConnected(ComponentName name, IBinder service) {
            ...
            DeclinedIntentService.MyBinder binder = (DeclinedIntentService.MyBinder) service;
    ...
    public void BindService() {
        ...
        if (mServiceConnection != null) {
            ...
            Intent intent = new Intent(getActivity(), DeclinedIntentService.class);
    ...
    public ArrayList<EnquiryColumns> getEnquiryList() {
        ...
        db.open();
        list = db.getEnquiry(declinedstatus);
        db.close();
        return list;
    }
    ...
    public void onAttach(Context activity) {
        ...
        try {
            mListener = (OnDeclinedFragment) activity;
    ...
    public void ReceiveEnquiry(Object enquiry) {
        ...
        Log.d("EnquiryReceivedDeclined", enquiry.toString());
    ...
    public interface OnDeclinedFragment {
