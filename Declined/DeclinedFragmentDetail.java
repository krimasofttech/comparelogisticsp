...
public class DeclinedFragmentDetail extends Fragment {
    View rootView;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (rootView == null) {
            rootView = inflater.inflate(R.layout.fragment_declined_fragment_detail, container, false);
            ;
        }
