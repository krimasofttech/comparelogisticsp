...
public class DeclinedIntentService extends IntentService implements CommonInterface, CommonUtility, Table {
    ...
    public DeclinedIntentService() {
        super("DeclinedIntentService");
    }
    ...
    public class MyBinder extends Binder {
        DeclinedIntentService getService() {
            return DeclinedIntentService.this;
        }
    }
