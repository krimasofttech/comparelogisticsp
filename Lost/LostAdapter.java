 ...
 */
public class LostAdapter extends RecyclerView.Adapter<LostAdapter.ViewHolder> implements CommonUtility {
    ...
    public static void setEnquirylist(ArrayList<EnquiryColumns> enquirylist) {
        LostAdapter.enquirylist = enquirylist;
    }
    ...
    public LostAdapter(Context context, ArrayList<EnquiryColumns> enquirylist) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View convertView) {
            ...
            statusicon.setImageResource(R.drawable.lost);
        }
    }
}
