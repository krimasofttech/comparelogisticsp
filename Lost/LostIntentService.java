...
public class LostIntentService extends IntentService implements CommonInterface, CommonUtility, Table {
    ...
    public LostIntentService() {
        super("LostIntentService");
    }
    ...
    public class MyBinder extends Binder {
        LostIntentService getService() {
            return LostIntentService.this;
        }
    }
}
