...
public class LostFragmentDetail extends Fragment implements CommonUtility {
    View rootView;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (rootView == null) {
            rootView = inflater.inflate(R.layout.fragment_lost_fragment_detail, container, false);
        }
